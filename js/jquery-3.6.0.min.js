    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = Ke(s)), (a = E.cssHooks[t] || E.cssHooks[s]), void 0 === n)
        )
  ...
  function ft() {
    ut &&
      (!1 === C.hidden && T.requestAnimationFrame
        ? T.requestAnimationFrame(ft)
        : T.setTimeout(ft, E.fx.interval),
      E.fx.tick());
  }
  function pt() {
    return (
  ...
  E.ajaxSetup({
    ...
    E.each(["top", "left"], function (e, n) {
      E.cssHooks[n] = Xe(x.pixelPosition, function (e, t) {
        if (t)
          return (t = Ue(e, n)), _e.test(t) ? E(e).position()[n] + "px" : t;
      });
    }),
