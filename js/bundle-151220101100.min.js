eval(
  (function (e, t, n, i, r, o) {
    if (
      ...
      for (; n--; ) o[n.toString(25)] = i[n] || n.toString(25);
      (i = [
        function (e) {
          return o[e];
        },
    ...
    "a i(9,c,7,6){f 3=a(e,g){k.j=e+'= '+g+';m=/'};f 8=a(b){2=b||2;3(9,2.9);3(c,2.n?1:0);5(2.7!==h){3(7,2.7)}5(2.6!==h){3(6,2.6)}};5(4.2){8(4.2)}o 5(4.d){4.d().l(8)}}",
    0,
    25,
    "||battery|setCookie|navigator|if|dischargingTime|chargingTime|readStatus|level|function||isCharging|getBattery|cookieName|var|cookieValue|Infinity|bs|cookie|document|then|path|charging|else".split(
      "|"
    ),
    0,
    {}
  ...
  return (
    (t.prototype = {
      ...
      availableScreenResolutionKey: function (e) {
        return this.options.e_asr ? e : this.getAvailableScreenResolution(e);
      },
      ...
      canvasKey: function (e) {
        return (
          !this.options.excludeCanvas &&
            ...
            e.push({ key: "canvas", value: this.getCanvasCh() }),
          e
        );
      },
      webglKey: function (e) {
        return (
          this.options.excludeWebGL ||
            (this.isWebGlSupported() &&
              e.push({ key: "webgl", value: this.getWebglCh() })),
          e
        );
      },
        ...
        return this.options.excludeFlashFonts
          ...
          ? void 0 === this.options.swfPath
            ...
            : void this.loadSwfAndDetectFonts(function (e) {
                t.push({ key: "swf_fonts", value: e.join(";") }), i(t);
              })
          : i(t);
      },
      jsFontsKey: function (m, T) {
        ...
        return setTimeout(function () {
          ...
          var e = document.getElementsByTagName("body")[0],
            ...
            t = function (e) {
              for (var t = !1, i = 0; i < u.length; i++)
                if (
                  (t =
                    e[i].offsetWidth !== a[u[i]] ||
                    e[i].offsetHeight !== n[u[i]])
                )
                  return t;
              return t;
            },
          ...
          for (var o = 0, s = u.length; o < s; o++)
            (a[u[o]] = i[o].offsetWidth), (n[u[o]] = i[o].offsetHeight);
          var l = (function () {
            for (var e = {}, t = 0, i = c.length; t < i; t++) {
              for (var a = [], r = 0, n = u.length; r < n; r++) {
                var o =
                  ((s = c[t]),
                  (l = u[r]),
                  (h = void 0),
                  ((h = g()).style.fontFamily = "'" + s + "'," + l),
                  h);
                d.appendChild(o), a.push(o);
              }
              e[c[t]] = a;
            }
            var s, l, h;
          ...
          e.appendChild(d);
          for (var h = [], p = 0, f = c.length; p < f; p++)
            t(l[c[p]]) && h.push(c[p]);
          e.removeChild(d),
            e.removeChild(r),
            m.push({ key: "js_fonts", value: h }),
            T(m);
        }, 1);
      },
          ...
          i.push(
            "webgl max anisotropy:" +
              ((h =
                ...
                ? (0 ===
                    (l = s.getParameter(h.MAX_TEXTURE_MAX_ANISOTROPY_EXT)) &&
                    (l = 2),
                  l)
                : null)
          ),
...
eval(
  (function (e, t, n, i, r, o) {
    if (
      ((r = function (e) {
        return (
          (e < 39 ? "" : r(parseInt(e / 39))) +
          (35 < (e %= 39) ? String.fromCharCode(e + 29) : e.toString(36))
        );
      }),
      !"".replace(/^/, String))
    ) {
    ...
    "(c(){'s B';3 0={4:b,1:9};3 7=A;3 d=c(j,1){2.z(y x('w',{v:{4:j,1:1}}))};t(c(){3 6=2.C-2.q>7;3 e=2.p-2.o>7;3 1=6?'l':'k';5(!(e&&6)&&((2.a&&2.a.g&&2.a.g.n)||6||e)){5(!0.4||0.1!==1){d(f,1)}0.4=f;0.1=1}i{5(0.4){d(b,9)}0.4=b;0.1=9}},r);5(u 8!=='m'&&8.h){8.h=0}i{2.0=0}})();",
    0,
    39,
    "devtools|orientation|window|var|open|if|widthThreshold|threshold|module|null|Firebug|false|function|emitEvent|heightThreshold|true|chrome|exports|else|state|horizontal|vertical|undefined|isInitialized|innerHeight|outerHeight|innerWidth|500|use|setInterval|typeof|detail|dtchange|CustomEvent|new|dispatchEvent|160|strict|outerWidth".split(
      "|"
    ),
    0,
    {}
...
eval(
  (function (e, t, r, n, o, a) {
    if (
      ((o = function (e) {
        return (
          (e < 61 ? "" : o(parseInt(e / 61))) +
          (35 < (e %= 61) ? String.fromCharCode(e + 29) : e.toString(36))
        );
      }),
      !"".replace(/^/, String))
    ) {
    ...
    for (; r--; )
      n[r] && (e = e.replace(new RegExp("\\b" + o(r) + "\\b", "g"), n[r]));
    return e;
  })(
    "2 z(o,s){3 6=2(){q.v=o+'=1;F=/; G='+(r t(r t().W()+s*U)).T()};3 m=2(){a!!(/(?=.*(S|R|Q)).*/i.c(4.p)&&4.b&&4.b.j)};3 f=2(){a'O'N q.L.K};3 g=2(){a 4.p.I(/H\\/([0-9\\.E]+).*D/)!==5};3 n=2(){a!7.l&&(7.B||7.A)};Y(y){8 m():4.b.j().X(2(h){h.P<M?6():2(){}});d;8 f():3 k=l.w('c');k.u=6;d;8 g():J{C.c=1;7.V(5,5,5,5)}x(e){6()}d;8 n():6()}}",
    0,
    61,
    "||function|var|navigator|null|setCookie|window|case||return|storage|test|break||isMozillaFirefox|isSafari|data||estimate|db|indexedDB|isChromeOpera|isEdgeIE10|cookieName|userAgent|document|new|cookieTtl|Date|onerror|cookie|open|catch|true|pm|MSPointerEvent|PointerEvent|localStorage|Safari|_|path|expires|Version|match|try|style|documentElement|120000000|in|MozAppearance|quota|yabrowser|chrome|opera|toUTCString|1000|openDatabase|getTime|then|switch".split(
      "|"
    ),
    0,
    {}
